  ...
  return (
    <div className="flex flex-col h-full animate-fade-in text-gray-900 dark:text-gray-100">
      <div className="relative flex items-center justify-center p-2 mb-4">
        ...
        <h1 className="text-xl font-bold">Varlık Ekle</h1>
      </div>
      ...
      <div className="flex-1 overflow-y-auto px-3 space-y-4 pb-32">
        {!isDirectAdd && (
          <div className="bg-white dark:bg-gray-800 rounded-2xl shadow p-4 border border-gray-200 dark:border-gray-700">
            <h2 className="text-sm font-semibold text-gray-500 dark:text-gray-400 mb-3">VARLIK TÜRÜ</h2>
            <div className="relative mb-2">
              ...
              <input
                ...
                className="w-full pl-11 pr-4 py-2.5 text-base border border-gray-200 dark:border-gray-600 rounded-xl bg-gray-50 dark:bg-gray-700 text-gray-900 dark:text-gray-100 placeholder-gray-400 dark:placeholder-gray-500 focus:ring-2 focus:ring-blue-500 focus:border-blue-500"
              />
            </div>
        ...
        <div className="bg-white dark:bg-gray-800 rounded-2xl shadow p-4 border border-gray-200 dark:border-gray-700">
          <h2 className="text-sm font-semibold text-gray-500 dark:text-gray-400 mb-3">İŞLEM DETAYLARI</h2>
            ...
            <div className="grid grid-cols-2 gap-4">
              <div>
                ...
                <input
                  ...
                  className="w-full p-3 bg-gray-100 dark:bg-gray-700 border-2 border-transparent rounded-xl text-base text-gray-900 dark:text-gray-100 focus:bg-white dark:focus:bg-gray-800 focus:border-blue-500"
                  placeholder="Örn: 10"
                  required
                />
              </div>
              <div>
                ...
                <input
                  ...
                  className="w-full p-3 bg-gray-100 dark:bg-gray-700 border-2 border-transparent rounded-xl text-base text-gray-900 dark:text-gray-100 disabled:bg-gray-200 dark:disabled:bg-gray-600 disabled:text-gray-500 focus:bg-white dark:focus:bg-gray-800 focus:border-blue-500"
                  placeholder="Fiyat"
                  required
                />
              </div>
      ...
      <div className="fixed bottom-0 left-0 right-0 p-4 bg-gray-100 dark:bg-gray-900/80 backdrop-blur-sm border-t border-gray-200 dark:border-gray-700">
        {totalCost > 0 && (
          <div className="flex items-center justify-between bg-blue-50 dark:bg-blue-900/50 text-blue-800 dark:text-blue-200 p-3 rounded-xl mb-3 shadow-md">
            <div className="flex items-center space-x-2">
